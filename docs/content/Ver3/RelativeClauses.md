...
<Note note="S">I</Note> <Note note="V">know</Note> <Note note="O">something</Note> <u>which nobody else knows</u>.
（我知道一件事，那是没有别人知道的。）
...
<Note note="S">They</Note> <Note note="V">live</Note> in glass houses.
...
<Note note="S">I</Note> <Note note="V">trust</Note> <Note note="O">the man</Note> completely.
（我完全信赖这个人。）
...
<Note note="S">I</Note> <Note note="V">trust</Note> <Note note="O">his judgment</Note>.
（我信赖他的判断。）
...
<Note note="S">The movies</Note> <Note note="V">make</Note> <Note note="O">me</Note> <Note note="C">think</Note>.
...
<Note note="S">I</Note> <Note note="V">saw</Note> <Note note="O">the movie</Note> last night.
...
<Note note="S">All ends</Note> well <Note note="V">in those movies</Note>.
...
<Note note="S">You</Note> <Note note="V">are</Note> <Note note="C">sitting</Note> <u>on that chair</u>.
...
<Note note="S">John</Note> <Note note="V">calls</Note> <Note note="O">his dog</Note> <Note note="C">the name</Note>.
...
<Note note="S">You</Note> <Note note="V">like</Note> <Note note="O">that (daughter)</Note>.
...
<Note note="S">I</Note> <Note note="V">can’t leave</Note> <Note note="O">a man</Note> <Note note="C">behind</Note>.
(我不能把这么一个人抛弃不顾。)

<Note note="S">This man</Note> <Note note="V">has done</Note> <Note note="O">so much</Note> for my family.
(此人为我家人做过那么多事。)
...
<Note note="S">I</Note> <Note note="V">can’t leave</Note> <Note note="O">a man</Note> <Note note="C">behind</Note>, [who has done so much for my family].
...
<Note note="S">The book</Note> <Note note="V">focuses on</Note> <Note note="O">social relations</Note>.
(这本书的重点在于社交关系。)
...
<Note note="S">You</Note> <Note note="V">mustn’t let</Note> <Note note="O">something</Note> <Note note="C">bother you</Note>.
(不要让一件事情困扰你。)

<Note note="S">He</Note> <Note note="V">said</Note> <Note note="O">something</Note>.
(他说了一件事情。)
...
<Note note="S">You</Note> <Note note="V">mustn’t let</Note> <Note note="O">something</Note> [that he said] <u>bother you</u>.

关系从句中的关系代词扮演宾语角色（是动词 said 的宾语），可以把它省略掉，如下：

<Note note="S">You</Note> <Note note="V">mustn’t let</Note> <Note note="O">something</Note> [he said] <u>bother you</u>.
...
<Note note="S">You</Note> <Note note="V">mustn’t let</Note> [what he said] <Note note="O">bother you</Note>.
...
<Note note="S">Anything</Note> <Note note="V">may be</Note> <Note note="C">used</Note> against you in court.
(任何事情都有可能在法庭上用来对你不利。)

<Note note="S">You</Note> <Note note="V">say</Note> <Note note="O">anything</Note> now.
(你现在说任何事情。)
...
<Note note="S">Anything</Note> [that you say now] <u>may be</u> <u>used</u> against you in court.
...
[Whatever you say now] <Note note="S">may be</Note> <u>used</u> against you in court.

这时候，复合关系代词 whatever 引导的关系从句因为包含先行词在内，已经升格成为名词从句、直接当做主要从句的主语使用。

### 三、whichever

<Note note="S">Any day</Note> <Note note="V">is</Note> <Note note="C">fine</Note> with me.
(随便哪一天我都可以。)

<Note note="S">You</Note> <Note note="V">choose</Note> <Note note="O">that day</Note>.
(你选择那天。)
...
<Note note="S">Any day</Note> [which you choose] <u>is</u> <u>fine</u> with me.
...
[Whichever day you choose] <Note note="S">is</Note> <u>fine</u> with me.

这时候，复合关系代词 whichever 引导的关系从句因为包含先行词在内，已经升格成为名词从句、直接当作主要从句的主语使用。

### 四、whoever(whomever)

<Note note="S">Any person</Note> <Note note="V">will win</Note> <Note note="O">1,000 dollars</Note>.
(任何人都可以赢得一千元。)

<Note note="S">The person</Note> <Note note="V">reaches</Note> <Note note="O">the mountaintop</Note> first.
(这个人最早爬到山顶。)
...
<Note note="S">Any person</Note> [who reaches the mountaintop first] <u>will win</u> <u>1,000 dollars</u>.
...
[Whoever reaches the mountaintop first] <Note note="S">will win</Note> <u>1,000 dollars</u>.

再看一个例子：

<Note note="S">The girl</Note> <Note note="V">will marry</Note> <Note note="O">any person</Note>.
(这个女孩愿意下嫁任何人。)

<Note note="S">The person</Note> <Note note="V">gives</Note> <Note note="O">her</Note> <Note note="O">a diamond ring</Note>.
(此人送她一枚钻戒。)

这两个句子在 person 上重复而建立关系，可以把句 2 的 the person 改写为关系代词 who、成为关系从句 who gives her a diamond ring，置于句 1 中的​​先行词 any person 之后，如下：

<Note note="S">The girl</Note> <Note note="V">will marry</Note> <Note note="O">any person</Note> [who gives her a diamond ring].

因为先行词 any person 没有什么内容，可以选择省略，只要把关系代词 who 改写为复合关系代词 whoever，如下：

<Note note="S">The girl</Note> <Note note="V">will marry</Note> [whoever gives her a diamond ring].
...
T<Note note="S">he person</Note> <Note note="V">returns</Note> first.
（此人最早回来。）
...
<Note note="S">Any person</Note> <Note note="V">qualifies</Note> for the job.
（任何人都有资格干这件工作。）

<Note note="S">You</Note> <Note note="V">see</Note> <Note note="O">the person</Note> in this room
（你在这个房间里看到的人。）

两句在 person 上重复建立关系。句2中的重复点 the person 是动词 see 的宾语，可以用关系​​代词 whom 或 that 连接，如下：

<Note note="S">Any person</Note> [whom you see in this room] <u>qualifies</u> for the job.

关系从句中的关系代词 whom 或 that 因为扮演宾语的角色，可以选择省略掉。但是，如果选择省略的是先行词 any person，那么关系代词必须改为复合关系代词 whomever，成为：

<Note note="S">Whomever you see in this room</Note> <u>qualifies</u> for the job.
...
<Note note="S">Most people</Note> <Note note="V">were</Note> sound <Note note="C">asleep then</Note>.
（这时大部分人都睡得正熟。）
...
<Note note="S">The earthquake</Note> <Note note="V">hit</Note> <u>when most people were sound asleep</u>.
...
Every year <Note note="S">the superstar</Note> <Note note="V">set aside</Note> <Note note="O">some time</Note> [when he can travel incognito with his wife].
...
<Note note="S">The superstar</Note> <Note note="V">doesn’t know</Note> <Note note="O">when he can travel incognito with his wife</Note>.
...
<Note note="S">He</Note> <Note note="V">knows</Note> <Note note="O">that he can travel incognito with his wife</Note>.
...
<Note note="S">The artist</Note> <Note note="V">lived</Note> in <u>a place</u>.
（这位艺术家住在一个地方。）

<Note note="S">It</Note> <Note note="V">was</Note> <Note note="C">impossible</Note> to work <u>there</u>.
（那里根本不可能工作。）
...
<Note note="S">The artist</Note> <Note note="V">lived</Note> <u>where it was impossible to work</u>.

这里的 where 不是改写而来的关系副词，而是外加的从属连词、引导一个地方状语从句，直接修饰主要从句动词 live 的地方。这时候，where既然不是关系词，当然也就不能改写为 that，而且也不能省略。

下面这个例子稍有不同：

<Note note="S">The artist</Note> <Note note="V">rented</Note> <Note note="O">an apartment</Note> [where he could work].
...
<Note note="S">I</Note> never <Note note="V">found out</Note> <Note note="O">the way</Note>.
（我一直没搞懂方法。）

<Note note="S">He</Note> <Note note="V">escaped</Note> <u>so</u>.
（他脱身就是用的这个方法。）

第 2 句中表示方法状态的副词 so，意思就是 in this way，和第 1 句中的先行词 the way 有交集而建立关系，可以改写为关系副词 how，移到句首来连接两句，成为这个复句：

<Note note="S">I</Note> never <Note note="V">found out</Note> <Note note="O">the way</Note> <u>how he escaped</u>.
...
<Note note="S">I</Note> never <Note note="V">found out</Note> <u>how he escaped</u>.
...
<Note note="S">I</Note> never <Note note="V">found out</Note> <u>(that) he escaped</u>.
...
<Note note="S">The man</Note> <Note note="V">didn’t explain</Note> <Note note="O">the reason</Note>.
（此人并未说明原因。）

<Note note="S">He</Note> <Note note="V">wanted</Note> <Note note="O">a divorce</Note> <u>for a rea​​son</u>.
（他要离婚是有原因的。）
...
<Note note="S">He</Note> <Note note="V">didn’t explain</Note> <Note note="O">why he wanted a divorce</Note>.
...
<Note note="S">He</Note> <Note note="V">said</Note> <Note note="O">that he wanted a divorce</Note>.
...
<Note note="S">Your friend</Note> <Note note="V">stole</Note> <Note note="O">a can of peaches</Note> <u>at a 7-11 last night</u>.
...
<Note note="S">It</Note> <Note note="V">was</Note> <Note note="C">your friend</Note> [<u>that(or who)</u> stole a can of peaches at a 7-11 last night].
...
<Note note="S">It</Note> <Note note="V">was</Note> <Note note="C">a can of peaches</Note> [<u>that(or which)</u> your friend stole at a 7-11 last night].

先行词是 a can of peaches，分裂句中的关系代词可以用 that 或 which。

<Note note="S">It</Note> <Note note="V">was</Note> <Note note="C">at a 7-11</Note> [<u>that(or where)</u> your friend stole a can of peaches last night].

先行词是 a 7-11，分裂句中的关系副词可以用 that 或 where。

<Note note="S">It</Note> <Note note="V">was</Note> <Note note="C">last night</Note> [<u>that(or when)</u> your friend stole a can of peaches at a 7-11].
...
<Note note="S">Your friend</Note> <Note note="V">stole</Note> <Note note="O">a can of peaches</Note> <u>at a 7-11</u> <u>last night</u>.
...
<Note note="S">The thing</Note> [that your friend did at a 7-11 last night] <u>was</u> <u>(to) steal a can of peaches</u>.

上句中的关系代词 that 和笼统的先行词 the thing 可以合并成为复合关系代词 what，关系从句 what your friend did at a 7-11 last night 升格成为名词从句当主要从句的主语使用，如下：

[What your friend did at a 7-11 last night] <Note note="S">was</Note> <Note note="V">(to) steal a can of peaches</Note>.

另外，主要从句的主语部分也可以采用如下的安排：

<Note note="S">All</Note> [(that) your friend did at a 7-11 last night] <u>was</u> <u>(to) steal a can of peaches</u>.

<Note note="S">The only thing</Note> [(that) your friend did last night] <u>was</u> <u>(to) steal a can of peaches at a 7-11</u>.
...
<Note note="S">I</Note> <Note note="V">can hope</Note>.

我可以怀抱希望。

这个句子如果要强调动词 hope，可以用 what one does is (to) V 的分裂句来强调如下：

<Note note="S">What I can do</Note> <Note note="V">is</Note> <Note note="C">(to) hope</Note>.

<Note note="S">All</Note> [(that) I can do] <u>is</u> <u>(to) hope</u>.

<Note note="S">The only thing</Note> [(that) I can do] <u>is</u> <u>(to) hope</u>.
...
<Note note="S">The program</Note> <Note note="V">backs up</Note> <Note note="O">important files</Note>.

这个程式是备份重要档案用的。

以同样的方式，可以制造出强调动词的分裂句如下：

[What the program does] <Note note="S">is</Note> <Note note="V">(to) backup important files</Note>.
...
<Note note="S">All</Note> [(that) I wanted] <u>was</u> <u>to help him</u>.

我想要做的只不过是要帮他而己。

主要从句的主语仍是笼统的 all，后面仍有关系从句修饰它，但是里面并没有助动词 do。这种情况，后面就不能采用原形动词当主语补语，只能用不定式短语 to help him。下面这个句子就不同了：

<Note note="S">All</Note> [(that) I wanted to do] <u>was</u> <u>(to) help him</u>.
