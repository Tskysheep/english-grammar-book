...
<Note note="S">The man</Note> <Note note="V">slept</Note> <u>on the couch</u>.

句中的动词是 slept，后面的 on the couch 是个介词短语，当地方副词使用、修饰动词 slept 的地方。第 2 句就不同了，是 S + V + O 的句型，如下：

<Note note="S">The man</Note> <Note note="V">turned on</Note> <Note note="O">the light</Note>.

这时候应该把 turned on 当一个动词来看（称为短语动词），后面的 the light 是动词 turned on 的宾语。因为，如果第 2 句仍然采用第 1 句的句型来诠释，成为：

<Note note="S">The man</Note> <Note note="V">turned</Note> <u>on the light</u>. （误）
...
除了时间、空间之外，还有一些介词用于表达其他的观念。比较值得注意的有以下这些。
