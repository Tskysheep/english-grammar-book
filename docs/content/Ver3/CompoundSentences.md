...
After years of hard work, <Note note="S">spring floods and summer droughts</Note> <Note note="V">have not been</Note> <Note note="C">eliminated from this area</Note>.

<Note note="S">Spring floods and summer droughts</Note> <Note note="V">may never be</Note> <Note note="C">eliminated from this area</Note>.
