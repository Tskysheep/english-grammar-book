...
<Note note="S">I</Note> <Note note="V">saw</Note> <Note note="O">the mirror</Note>.
（我看到镜子。）

<Note note="S">I</Note> <Note note="V">saw</Note> <Note note="O">that the mirror was broken</Note>.
（我看到镜子是破的。）
...
<Note note="S">I</Note> <Note note="V">believe</Note> <Note note="O">that</Note>.
（我相信那件事。）
...
<Note note="S">What</Note> <Note note="V">happened</Note> at his party?
（他开的宴会出了什么事？）

<Note note="S">I</Note> never <Note note="V">asked</Note> <Note note="O">him</Note> <Note note="O">the question</Note>.
（我一直没问他这个问题。）
...
<Note note="S">I</Note> never <Note note="V">asked</Note> <Note note="O">him</Note> <Note note="O">what happened at his party</Note>.
...
<Note note="S">He</Note> never <Note note="V">revealed</Note> <Note note="O">the question</Note>.
（这个问题他从未透露。）
...
<Note note="S">He</Note> never <Note note="V">revealed</Note> <Note note="O">where he kept the money</Note>.
...
By looking at the sky, <Note note="S">I</Note> <Note note="V">can tell</Note> <Note note="O">the question</Note>.
（只要看看天色，我就能够判断这个问题。）
...
By looking at the sky, <Note note="S">I</Note> <Note note="V">can tell</Note> <Note note="O">whether it is going to rain (or not)</Note>.
...
<Note note="S">Whether we can win the big prize</Note> <u>will be</u> <u>decided</u> soon.
（我们是否能够赢得大奖，不久便见分晓。）
...
<Note note="S">Something</Note> <Note note="V">is</Note> <Note note="C">an undeniable fact</Note>.
（有一件事是无法否认的事实。）
...
<Note note="S">That the suspect has a strong alibi</Note> <u>is</u> <u>an undeniable fact</u>.
...
<Note note="S">It</Note> <Note note="V">is</Note> <Note note="C">an undeniable fact</Note> <u>(that) the suspect has a strong alibi</u>.
...
<Note note="S">The question</Note> <Note note="V">is</Note> <Note note="C">a big mystery</Note>.
...
<Note note="S">Where he is hiding now</Note> <u>is</u> <u>a big mystery</u>.

另外，为了避免头重脚轻，也可以选择用虚字it暂代主语位置，而把真正的主语（名词从句）往后移，成为这样的复句：

<Note note="S">It</Note> <Note note="V">is</Note> <Note note="C">a big mystery</Note> <u>where he is hiding now</u>.
...
<Note note="S">Many people</Note> <Note note="V">believe</Note> <Note note="O">something</Note>.
（许多人相信一件事。）
...
<Note note="S">Many people</Note> <Note note="V">believe</Note> <Note note="O">(that) one’s zodiac sign determines one’s character</Note>.
...
<Note note="S">I</Note> <Note note="V">find</Note> <Note note="O">something</Note> <Note note="C">amazing</Note>.
（我觉得有件事实在很惊人。）
...
<Note note="S">I</Note> <Note note="V">find</Note> <Note note="O">it</Note> <Note note="C">amazing</Note> <u>(that) you still look so young</u>.
...
<Note note="S">He</Note> <Note note="V">explained</Note> <Note note="O">the question</Note>.
（他解释了这个问题。）
...
<Note note="S">He</Note> <Note note="V">explained</Note> <Note note="O">why he had bought do much of that stock</Note>.
...
<Note note="S">It</Note> <Note note="V">seems</Note> <Note note="C">something</Note>.
（似乎有一件事。）
...
<Note note="S">It</Note> <Note note="V">seems</Note> <Note note="C">(that) we’re going to win this game after all</Note>.
（看起来这场比赛我们终究还是会赢。）
...
We all know what happened. <Note note="S">The question</Note> <Note note="V">is</Note> <Note note="C">this</Note>.
（我们都知道出了什么事。问题是这个。）
...
<Note note="S">The question</Note> <Note note="V">is</Note> <Note note="C">whether we can do anything about it</Note>.
...
<Note note="S">The woman</Note> <Note note="V">can’t forget</Note> <Note note="O">the fact</Note> <u>(that) her husband cheated on her</u>.
...
<Note note="S">The student</Note> <Note note="V">is</Note> <Note note="C">worried</Note> <u>(that) he may fail in the exam</u>.
（这个学生担心他考试可能会不及格。）
...
<Note note="S">The family</Note> <Note note="V">was</Note> <Note note="C">unaware</Note> <u>(that) a burglar had broken into the cellar</u>.
（这家人并不知道有个窃贼已经闯入了地下室。）
...
<Note note="S">I</Note> <Note note="V">am</Note> not <Note note="C">sure</Note> <u>what caused the delay</u>.
...
<Note note="S">My response</Note> <Note note="V">depends</Note> <u>on the question</u>.
（我的回应要视一个问题而定。）
...
<Note note="S">His response</Note> <Note note="V">dwells</Note> on the fact.
（他的回应一直强调一件事实。）
...
<Note note="S">The guard</Note> <Note note="V">said</Note>, <Note note="O">“The road is closed.”</Note>

<Note note="S">The guard</Note> <Note note="V">said</Note> <Note note="O">(that) the road was closed</Note>.
(警卫说道路封闭了。)
...
<Note note="S">Frank Kazinsky</Note>, chief analyst for the International Monetary Fund and an expert on oil, <Note note="V">says</Note> <Note note="O">that oil prices will keep rising until the supply completely runs dry</Note>.
