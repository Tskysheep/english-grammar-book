...
<Note note="S">The dog</Note> <Note note="V">barked</Note> <u>furiously</u> at the mailman.
(狗冲着邮差叫得很凶。)
...
<Note note="S">He</Note> <Note note="V">stayed</Note> <Note note="C">single</Note> <u>reluctantly</u>.
(他很不情愿地维持单身。)
...
<Note note="S">He</Note> <Note note="V">harassed</Note> <Note note="O">the girl</Note> <u>openly</u>.
(他公开骚扰那个女孩。)

方法状态的副词 openly 修饰动词 harassed，但是因为有宾语 the girl 这个主要元素，所以被挤到宾语后面去。另一个选择是放在动词前面，如下：

<Note note="S">He</Note> <u>openly</u> <u>harassed</u> <u>the girl</u>.

如果是下面这个句子，方法状态的副词 openly 该放在什么位置就要特别小心：

<Note note="S">He</Note> <Note note="V">harassed</Note> <Note note="O">the girl</Note> sitting at the counter.
(他骚扰那个坐在柜台的女孩。)
...
<Note note="S">His father</Note> <Note note="V">bought</Note> <Note note="O">him</Note> <Note note="O">a car</Note> <u>generously</u>.
(他父亲很大方地买了辆车给他。)

方法状态的副词 generously 修饰动词 bought，但是被挤到 him 和 a car 这两个宾语的后面去。另一个可能的位置是放在动词 bought 的前面，成为 generously bought。

<Note note="S">The student</Note> <u>politely</u> <u>asked</u> <u>the speaker</u> <u>a question</u>.
(学生很有礼貌地问了演说人一个问题。)
...
<Note note="S">I</Note> <Note note="V">consider</Note> <Note note="O">you</Note> <Note note="C">a member of the family</Note> <u>proudly</u>.
(我很骄傲地视你为自己家人。)
...
<Note note="S">The boss</Note> <Note note="V">wanted</Note> <Note note="O">this man</Note> <Note note="C">to be punished badly</Note>. (不佳)
...
When you shake someone's hand, <Note note="S">you</Note> <Note note="V">should hold</Note> <Note note="O">it</Note> <u>firmly</u>, to show sincerity.
（与人握手时应用力，以示诚意。）
...
<Note note="S">The man</Note> <Note note="V">wiped</Note> <Note note="O">the windshield</Note> <Note note="C">clean</Note>.
（这个人把挡风玻璃擦干净。）

这是 S + V + O + C 的句型，形容词 clean 是宾语补语，修饰宾语 windshield。

<Note note="S">He</Note> <Note note="V">types</Note> <u>cleanly</u> and neatly.
（他打字又干净又整齐。）
...
<Note note="S">The teacher</Note> <Note note="V">explained</Note> <Note note="O">the lesson</Note> <u>clearly</u>.
（老师以相当清楚的方式解说这一课。）

方法状态的副词 clearly 修饰动词 explain。

<Note note="S">She</Note> <Note note="V">made</Note> <Note note="O">the lesson</Note> very <Note note="C">clear</Note> to all her students.
（她让学生都很清楚这一课的内容。）
