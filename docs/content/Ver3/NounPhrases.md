...
名词短语 a chip 后面虽然有介词短语 in that pile 修饰它，但是这时候并无指示性：「一堆筹码里面」并没有指出是「哪一枚」，所以只能说 a chip，代表 one chip。
...
The Dominican Republic「多明尼加共和国」是国名，乍看之下是专有名词，但是仔细看看：名词位置是 Republic，这是个普通名词，属于通称：有许多国家都叫作 republic，所以它也是个假专有名词、可以加 the。再看「美国」：名词部分是 States，不仅是普通名词，甚至还是个复数！所以它也是个假专有名词。只有它后面那个介词短语 of America 里头的 America 才是真正的专有名词，前面没有限定词。另外还有一种常见的情况：
...
<Note note="S">Bill Gates</Note> <Note note="V">is</Note> <Note note="C">Chairman</Note> of Microsoft.
（比尔盖兹是微软公司董事长。）
...
<Note note="S">Bill Gates</Note>, according to some, <Note note="V">is</Note> <Note note="C">a better Chairman</Note> than Craig Barrett.
...
<Note note="S">Bill Gates</Note> <Note note="V">is</Note> also <Note note="C">a trustee</Note> of the Bill & Melinda Gates Foundation.
...
<Note note="S">Queen Elizabeth</Note> <Note note="V">made</Note> <Note note="O">Charles</Note> <Note note="C">Prince of Wales</Note>.
（伊莉莎白女王封查尔斯为威尔斯亲王。）
