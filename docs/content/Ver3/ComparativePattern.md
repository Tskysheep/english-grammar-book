...
不过，比较句法虽然近似对等从句，但是比较级的句子毕竟还是从属从句中的状语从句类，所以有些变化又和对等从句不同。例如比较句法经常可以选择用倒装句来表示，这就和一般的对等从句不一样。
...
<Note note="S">Unit 3</Note> <Note note="V">is</Note> <Note note="C">long</Note>.

<Note note="S">Unit 4</Note> <Note note="V">is</Note> not so <Note note="C">long</Note>.
...
<Note note="S">Unit 4</Note> <Note note="V">is</Note> <Note note="C">boring</Note>.

<Note note="S">Unit 3</Note> <Note note="V">is</Note> <Note note="C">boring</Note>.
...
His father left him more money [than <Note note="S">he</Note> <Note note="V">can ever spend</Note>].
（他父亲留下来的钱，他一辈子也花不完。）

中括号内的部分是个从属从句，当中主语是 he，动词是 can spend，后面本来应该有个宾语 money。乍看之下好像是 than 一方面扮演连词的角色、一方面又扮演代词的角色（代表 money、当宾语）。如果这样看待，那么 than 的功能和关系代词 which 确实是差不多。但是这样解读是不对的。上面那句话可以拆开为以下两句来切入：

<Note note="S">His father</Note> <Note note="V">left</Note> <Note note="O">him</Note> <Note note="O">much money</Note>.

<Note note="S">He</Note> <Note note="V">can spend</Note> not so <Note note="O">much money</Note>.
...
<Note note="S">This university</Note> <Note note="V">cannot possibly take in</Note> <Note note="O">many students</Note>.

<Note note="S">Many students</Note> <Note note="V">meet</Note> <Note note="O">its requirements</Note>.
...
<Note note="S">Yellowstone</Note> <Note note="V">is</Note> <Note note="C">crowded</Note>.
（黄石公园人潮汹涌。）

<Note note="S">Yellowstone</Note> <Note note="V">is</Note> <Note note="C">most crowded</Note> in summer.
（ 夏天黄石公园的人潮最多。）
...
这个句子当中也没有比较级，只是用介词 like 来表示「相像」。这也构成一种比较、也就必须顾虑比较对象的平行对称要求。句中是拿 Shakespeare 这个「人」和 Keats' poetry 这个「物」互相比较，并不符合平行对称要求。可修改如下：
...
<Note note="S">These restaurateurs</Note> <Note note="V">do</Note> <Note note="O">a lot of business</Note> with tourists.
（这些餐厅业者做到许多观光客的生意。）

<Note note="S">Local farmers</Note> <Note note="V">do</Note> <Note note="O">little business</Note> with tourists.
（本地农民做不到什么观光客的生意。）
...
<Note note="S">These restaurateurs</Note> <Note note="V">do</Note> <Note note="O">little business</Note> with local farmers.
(这些餐厅业者做不到多少本地农民的生意。)
...
连词 than 引导的状语从句，中间省略掉了重复的比较点 business。状语从句的主语 these restaurateurs 和主要从句主语完全一样，可以用人称代词来取代，成为：
...
<Note note="S">Manual laborers</Note> <Note note="V">are</Note> strongly <Note note="C">opposed</Note> to <u>immigrants</u>.
(粗工强烈排斥移民。)

<Note note="S">Manual laborers</Note> <Note note="V">are</Note> not so strongly <Note note="C">opposed</Note> to <u>white-collar workers</u>, whose jobs are not seriously threatened by outsiders that swarm into this country.
...
<Note note="S">Manual laborers</Note> <Note note="V">are</Note> strongly <Note note="C">opposed</Note> to immigrants.
(粗工强烈排斥移民。)

<Note note="S">White-collar workers</Note>, whose jobs are not seriously threatened by outsiders that swarm into this country, <Note note="V">are</Note> not very strongly <Note note="C">opposed</Note> to immigrants.
